...
(2, 2, '2021-03-22', 555, 55, 5, 5, 55, 55, 555, '0', 1, '2021-03-01', 0);
...
(1, 2, 4, 2, '2021-03-25', '2021-06-30', '1', 25, 30, 4500);
...
CREATE TABLE `payment` (
  ...
  `amount_date` int(11) NOT NULL COMMENT 'จำนวนวันเกินกำหนด',
  `pay_fine` int(11) NOT NULL COMMENT 'ค่าปรับ',
...
CREATE TABLE `renter` (
  ...
  `r_add` varchar(100) NOT NULL COMMENT 'ที่อยู่',
...
(4, 'asd', '06896355', '142536', 'aaaaaaaa', 'a@gmail.com', 'a', '7f8199312f2c0cf56ef85ad625be6aaa');
...
--
ALTER TABLE `invoice`
  MODIFY `invoice_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสบิลค่าเช่าห้องพัก', AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `leases`
--
ALTER TABLE `leases`
  MODIFY `leases_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'เลขที่สัญญาเช่า', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `news`
--
ALTER TABLE `news`
  MODIFY `news_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสข่าวสาร', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `payment`
--
ALTER TABLE `payment`
  MODIFY `pay_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสการชำระ', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `renter`
--
ALTER TABLE `renter`
  MODIFY `rid` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสผู้เช่า', AUTO_INCREMENT=5;
...
ALTER TABLE `renter` CHANGE `r_add` `r_add` TEXT CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'ที่อยู่';
COMMIT;
